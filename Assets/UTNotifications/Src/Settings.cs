...
#pragma warning restore 414
        ...
        private void CheckAssetVersionUpdated()
        {
            ...
            {
                if (EditorUtility.DisplayDialog("UTNotifications has been updated to version " + Version, m_assetUpdateMessage, "Yes", "No"))
                {
                    EditSettigns();
                }
        ...
        private const string m_assetUpdateMessage =
            @"Breaking changes:
