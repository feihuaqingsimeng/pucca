...
public partial class Character : Node
{
    ...
    {
        // TEST
        var packet = new PACKET_CG_CARD_EDIT_DECK_INFO_SYN();
        PACKET_CG_CARD_SYN _card = packet;
        PACKET_BASE _base = packet;

        packet.m_DeckList = deckDataList;
        Kernel.networkManager.WebRequest(packet);
    ...
    {
        var deckList = packet.m_DeckList;
        //deckDataList = packet.m_DeckList;
        SetDirty(false);
    }
