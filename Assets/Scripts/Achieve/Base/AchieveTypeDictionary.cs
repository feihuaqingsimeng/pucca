...
public /*static*/ class AchieveTypeDictionary : Dictionary<int, Type>
{
    // Key is achieveGroup.
    // Value is AchieveBase.

    public AchieveTypeDictionary()
    {
        ...
        this[35] = typeof(AchieveCardCollectGradeSS);                   // SS등급 카드 획득 수
        ...
        this[47] = typeof(AchievePvEAllStageClearNormal);               // 스테이지 전체 클리어 (1차)
        this[48] = typeof(AchievePvEAllStageClearHard);                 // 스테이지 전체 클리어 (2차)
    }
}
