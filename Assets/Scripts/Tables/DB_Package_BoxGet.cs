...
public class DB_Package_BoxGet : TableBase<DB_Package_BoxGet, DB_Package_BoxGet.Schema>
{
	[Serializable]
	public class Schema
	{
	...
	public static class Field
	{
		...
		public static string Star_Point = "Star_Point";
	...
	public override bool FromAssetBundle(AssetBundle assetBundle)
	{
		if (assetBundle != null)
		{
			UnityEngine.Object asset = assetBundle.LoadAsset("DB_Package_BoxGetScriptableObject");
			if (asset != null)
			{
				DB_Package_BoxGetScriptableObject scriptableObject = asset as DB_Package_BoxGetScriptableObject;
