...
public class DB_BoxGet : TableBase<DB_BoxGet, DB_BoxGet.Schema>
{
	[Serializable]
	public class Schema
	{
	...
	public override bool FromAssetBundle(AssetBundle assetBundle)
	{
		if (assetBundle != null)
		{
			UnityEngine.Object asset = assetBundle.LoadAsset("DB_BoxGetScriptableObject");
			if (asset != null)
			{
				DB_BoxGetScriptableObject scriptableObject = asset as DB_BoxGetScriptableObject;
